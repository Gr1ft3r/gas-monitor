    ...
    <div className="min-h-screen bg-gray-100 font-sans pb-10">
      ...
      <main className="max-w-md mx-auto mt-4 px-4">
        ...
        <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg mb-5 shadow-sm">
          ...
          <p className="text-blue-900 text-xs leading-relaxed mb-3">Baseline prices are synced weekly with <strong>Department of Energy (DOE)</strong> advisories. Because actual pump prices vary by region due to logistics costs, this platform relies on <strong>local crowdsourcing</strong>. Help fellow drivers by verifying or updating prices when you fuel up!</p>
